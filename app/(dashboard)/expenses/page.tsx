...
export default async function ExpensesPage() {
  ...
  // Note: For full accuracy, we'd add maintenance cost too.
  // We'll calculate total fuel cost here.
        ...
        <div className="md:col-span-1 border-r border-neutral-100 pr-4 space-y-4">
          <Card className="bg-gradient-to-br from-indigo-50 to-white shadow-sm border-indigo-100">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-indigo-800">Total Fuel Expense</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-indigo-900">${totalFuelCost.toLocaleString(undefined, { minimumFractionDigits: 2 })}</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-emerald-50 to-white shadow-sm border-emerald-100">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-emerald-900">{totalLiters.toLocaleString()} <span className="text-base font-normal">Liters</span></div>
            </CardContent>
          </Card>
